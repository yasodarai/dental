...
if(isset($_GET['del']))
		  {
		  		$result = mysqli_query($con,"select specilization from doctorSpecilization where id = '".$_GET['id']."'");
		  		$doctor_spec = mysqli_fetch_array($result);
		  		$doctor_spec = $doctor_spec['specilization'];
		          mysqli_query($con,"delete from doctorSpecilization where id = '".$_GET['id']."'");
                  $_SESSION['msg']= $doctor_spec. " Deleted !!";
		  }
?>
<!DOCTYPE html>
<html lang="en">
